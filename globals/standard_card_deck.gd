...
var all_standard_cards: Array[Array] = [
	[ #cards that have fixed amounts per game
	...
	[ #cards that have player count based amounts per game (card_amount = max_player_count)
	...
	{"cardname": "stadium",				"card_count": 4,	"card_id": 17,	"card_path": preload("res://card_scenes/stadium.tscn")},
	{"cardname": "tv_channel",			"card_count": 4,	"card_id": 18,	"card_path": preload("res://card_scenes/tv_channel.tscn")},
	{"cardname": "office_complex",		"card_count": 4,	"card_id": 19,	"card_path": preload("res://card_scenes/office_complex.tscn")},
	]
	]:
	get:
